  ...
  return (
    <Dialog>
      ...
      <DialogContent className="bg-white max-w-3xl text-gray-800 rounded-2xl shadow-2xl p-6 sm:p-8 overflow-y-auto max-h-[90vh]">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-yellow-600">{title}</DialogTitle>
        </DialogHeader>
          ...
          <div className="mt-4 space-y-4">
            <div className="bg-yellow-50 p-4 rounded-xl">
              ...
              <p className="mt-2 text-sm text-yellow-600 font-semibold">
                ...
                <br /> Tổng hợp các kĩ năng đã học để thực hiện 1 bài thuyết trình hoàn chỉnh, định hình dấu ấn lãnh đạo
                của riêng mình
              </p>
            </div>
            ...
            <div className="flex justify-end mt-6">
              <DialogClose asChild>
                <button
                  onClick={() => {
                    // Đợi dialog đóng trước khi cuộn
                    setTimeout(() => {
                  ...
                  className="inline-block bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-5 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg text-sm cursor-pointer"
                >
                  Tìm hiểu ngay
                </button>
              </DialogClose>
    ...
    <section className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      <div className="container mx-auto px-6">
        <div className="relative mb-8 border-b-2 border-[#d7a13d] pb-2 inline-block">
          <h2 className="text-3xl md:text-4xl font-bold tracking-widest uppercase">Chương trình học</h2>
        </div>
